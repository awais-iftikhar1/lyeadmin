...
const QuickLinks: FC = () => (
  ...
  >
    ...
    <div className='row g-0'>
      ...
      <div className='col-6'>
        <p className='d-flex flex-column flex-center h-100 p-6 bg-hover-light border-bottom'>
          <KTSVG
      ...
      <div className='col-6'>
        <p className='d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end'>
          <KTSVG
      ...
      <div className='col-6'>
        <p className='d-flex flex-column flex-center h-100 p-6 bg-hover-light'>
          <KTSVG
