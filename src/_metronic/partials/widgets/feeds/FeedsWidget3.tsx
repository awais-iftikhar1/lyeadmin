      ...
      <div className='card-body pb-0'>
        ...
        <div className='mb-7'>
          ...
          <div className='d-flex align-items-center mb-5'>
            ...
            <p className='btn btn-sm btn-light btn-color-muted btn-active-light-danger px-4 py-2'>
              <KTSVG
          ...
          <div className='d-flex mb-5'>
            ...
            <div className='d-flex flex-column flex-row-fluid'>
              ...
              <div className='d-flex align-items-center flex-wrap mb-1'>
                <p className='text-gray-800 text-hover-primary fw-bold me-2'>
                  Alice Danchik
                </p>

                <span className='text-gray-400 fw-semibold fs-7'>1 day</span>

                <p className='ms-auto text-gray-400 text-hover-primary fw-semibold fs-7'>
                  Reply
                </p>
              </div>
              {/* end::Info */}
