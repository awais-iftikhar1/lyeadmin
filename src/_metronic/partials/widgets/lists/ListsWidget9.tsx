        ...
        <div className='d-flex mb-7'>
          ...
          <div className='d-flex align-items-center flex-wrap flex-grow-1 mt-n2 mt-lg-n1'>
            ...
            <div className='d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3'>
              <p className='fs-5 text-gray-800 text-hover-primary fw-bolder'>
                Cup &amp; Green
              </p>
              ...
              <span className='text-gray-400 fw-bold fs-7'>
                By:
                <p className='text-primary fw-bold'>CoreAd</p>
              </span>
            </div>
            {/*end::Title*/}
            {/*begin::Info*/}
        ...
        <div className='d-flex mb-7'>
          ...
          <div className='d-flex align-items-center flex-wrap flex-grow-1 mt-n2 mt-lg-n1'>
            ...
            <div className='d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3'>
              ...
              <span className='text-gray-400 fw-bold fs-7'>
                By:
                <p className='text-primary fw-bold'>KeenThemes</p>
              </span>
            </div>
            {/*end::Title*/}
            {/*begin::Info*/}
        ...
        <div className='d-flex mb-7'>
          ...
          <div className='d-flex align-items-center flex-wrap flex-grow-1 mt-n2 mt-lg-n1'>
            ...
            <div className='d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3'>
              ...
              <span className='text-gray-400 fw-bold fs-7'>
                By:
                <p className='text-primary fw-bold'>Invision Inc.</p>
              </span>
            </div>
            {/*end::Title*/}
            {/*begin::Info*/}
        ...
        <div className='d-flex mb-7'>
          ...
          <div className='d-flex align-items-center flex-wrap flex-grow-1 mt-n2 mt-lg-n1'>
            ...
            <div className='d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3'>
              ...
              <span className='text-gray-400 fw-bold fs-7'>
                By:
                <p className='text-primary fw-bold'>Figma Studio</p>
              </span>
            </div>
            {/*end::Title*/}
            {/*begin::Info*/}
