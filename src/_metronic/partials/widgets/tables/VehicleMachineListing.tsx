...
const VehicleMachineListing: React.FC<Props> = ({
  className,
  loading,
  setRefreshList,
  setTabIndex,
  ...
  const deleteItemHandler = async () => {
    ...
    setIsLoading(true);
    try {
      const data = await deleteVehicleMachineType(itemId);
      console.log(data);
  ...
  return (
    <>
              ...
              <table className='table align-middle gs-0 gy-4'>
                ...
                <thead>
                  <tr className='fw-bold text-muted bg-light'>
                    <th className='ps-4 min-w-150px rounded-start'>Vehicle Type</th>
      ...
      <ConfrimModal
        ...
        modalTitle={'Delete Vehicle Machine'}
