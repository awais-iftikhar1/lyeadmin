...
import { deleteOilManufacture } from '../../../../app/api/Oil';
type Props = {
  className: string;
  loading: boolean;
...
const OilManufactureListing: React.FC<Props> = ({
  className,
  loading,
  setRefreshList,
  setTabIndex,
  ...
  const tabName = ROUTES.OilManfacture
  ...
  const deleteItemHandler = async () => {
    ...
    setIsLoading(true);
    try {
      const data = await deleteOilManufacture(itemId);
      console.log(data);
