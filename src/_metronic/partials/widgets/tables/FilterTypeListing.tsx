...
import { FilterType } from '../../../../app/modules/apps/filter-management/types';
import { deleteFilterType } from '../../../../app/api/filterType.ts';
import FilterTypeAddEdit from '../../../../app/modules/apps/filter-management/filters/filterType-add-edit';
type Props = {
  className: string;
  loading: boolean;
...
const FilterTypeListing: React.FC<Props> = ({
  className,
  loading,
  setRefreshList,
  setTabIndex,
  ...
  const [listDetails, setListDetails] = useState<FilterType|null>(null);
  ...
  const ItemDetail = async (data: FilterType|null) => {
  ...
  const deleteItemHandler = async () => {
    ...
    setIsLoading(true);
    try {
      const data = await deleteFilterType(itemId);
      console.log(data);
