        ...
        <div className='card-p mt-n20 position-relative'>
          ...
          <div className='row g-0'>
            ...
            <div className='col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7'>
              ...
              />
              <p className='text-warning fw-semibold fs-6'>Weekly Sales</p>
            </div>
            {/* end::Col */}
            {/* begin::Col */}
            <div className='col bg-light-primary px-6 py-8 rounded-2 mb-7'>
              ...
              />
              <p className='text-primary fw-semibold fs-6'>New Users</p>
            </div>
            {/* end::Col */}
          </div>
          {/* end::Row */}
          ...
          <div className='row g-0'>
            ...
            <div className='col bg-light-danger px-6 py-8 rounded-2 me-7'>
              ...
              />
              <p className='text-danger fw-semibold fs-6 mt-2'>Item Orders</p>
            </div>
            {/* end::Col */}
            {/* begin::Col */}
            <div className='col bg-light-success px-6 py-8 rounded-2'>
              ...
              />
              <p className='text-success fw-semibold fs-6 mt-2'>Bug Reports</p>
            </div>
            {/* end::Col */}
          </div>
          {/* end::Row */}
