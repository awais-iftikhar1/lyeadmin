...
const YearDetails = () => {
  ...
  return (
      ...
      <Route
        ...
        element={
          <>
            ...
            <PageTitle breadcrumbs={breadCrumbsData.Year}>{routes[route as keyof typeof routes] }</PageTitle>
    ...
    <Route
      index
      element={<Navigate to='/apps/year-management/year' />}
    />
  </Routes>
  );
};
