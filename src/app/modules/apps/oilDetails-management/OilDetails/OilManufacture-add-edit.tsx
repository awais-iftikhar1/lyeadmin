...
import { addOilManufacture, editOilManufacture } from '../../../../api/Oil';
  ...
  const editPackagesHandler = async (formData: OilData) => {
    ...
    try {
      ...
      if (actionType === 'edit') {
        ...
        await editOilManufacture(updData);
      } else {
        await addOilManufacture(
          { ...formData }
        );
      }
      handleClose();
...
display:flex
`
export default OilManufactureAddEdit;
