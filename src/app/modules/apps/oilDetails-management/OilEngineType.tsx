...
import { viewOilEngineType, viewOilManufacture } from '../../../api/Oil';
import { OilEngineTypeListing } from '../../../../_metronic/partials/widgets/tables/OilEngineTypeListing';
...
const OilEngineType = () => {
  ...
  const filterData = async (pageSize: number, page: number) => {
    setIsLoading(true);
    try {
      const data = await viewOilEngineType();
      console.log(data);
