...
import { routes, status, vehicleMachineTypes } from '../../../../utils/constants/index';
...
const VehicleAddEdit = ({
  ...
  const editPackageSchema = Yup.object().shape({
    ...
    numberPlate: Yup.number()
      .required('numberPlate is required'),
    vin: Yup.number()
    ...
    countryOfManufacture: Yup.string()
      .required('countryOfManufacture is required'),
    licenseIssueDate: Yup.string()
      .required('licenseIssueDate is required'),
    licenseExpiryDate: Yup.string()
      .required('licenseExpiryDate is required'),
    notes: Yup.string()
      .required('notes is required'),
    mileage: Yup.number()
      .required('mileage is required'),
    mileageType: Yup.string()
      .required('mileageType is required'),
  });
  ...
  useEffect(() => {
    ...
    formik.setFieldValue(
      'pictureOfVehicleFront',
      files[0]?.file
    );
    formik.setFieldValue(
      'pictureOfVehicleBack',
      files[1]?.file
    );
    formik.setFieldValue(
      'pictureOfVehicleEngine',
      files[2]?.file
    );
    formik.setFieldValue(
      'pictureOfVehicleVin',
  ...
  useEffect(() => {
    if (selectedValue && Object.keys(selectedValue).length > 0) {
      ...
      debugger
      setSelectedValue({
        label: filterDropDownData.find((obj: any) => obj.value === vehicleData.type)?.label!,
        ...
        <FormikProvider value={formik}>
          <form onSubmit={formik.handleSubmit} noValidate className='form'>
                  ...
                  <Flex style={{ display: "flex" }}>
                    ...
                    <div className='col-lg-9 fv-row position-relative'>
                      ...
                      {formik.touched.vehicleTypeId && formik.errors.vehicleTypeId && (
                        <div className='fv-plugins-message-container'>
                          <div className='fv-help-block'>{formik.errors.vehicleTypeId}</div>
                        </div>
                      )}
                    </div>
                  </Flex>
                ...
                <div className='col-lg-6'>
                  <Flex>
                    ...
                    <div className='col-lg-9 fv-row '>
                      ...
                      />
                      {formik.touched.countryOfManufacture && formik.errors.countryOfManufacture && (
                        <div className='fv-plugins-message-container'>
                          <div className='fv-help-block'>{formik.errors.countryOfManufacture}</div>
                        </div>
                      )}
                    </div>
                  </Flex>
                  ...
                  <Flex style={{ display: "flex" }}>
                    ...
                    <div className='col-lg-8 fv-row position-relative'>
                      ...
                      {formik.touched.licenseStatus && formik.errors.licenseStatus && (
                        <div className='fv-plugins-message-container'>
                          <div className='fv-help-block'>{formik.errors.licenseStatus}</div>
                        </div>
                      )}
                    </div>
                  </Flex>
                ...
                <div className='col-lg-6'>
                  <Flex>
                    ...
                    <div className='col-lg-9 fv-row '>
                      ...
                      />
                      {formik.touched.licenseIssueDate && formik.errors.licenseIssueDate && (
                        <div className='fv-plugins-message-container'>
                          <div className='fv-help-block'>{formik.errors.licenseIssueDate}</div>
                        </div>
                      )}
                    </div>
                  </Flex>
                  ...
                  <Flex style={{ display: "flex" }}>
                    ...
                    <div className='col-lg-8 fv-row position-relative'>
                      ...
                      {formik.touched.licenseExpiryDate && formik.errors.licenseExpiryDate && (
                        <div className='fv-plugins-message-container'>
                          <div className='fv-help-block'>{formik.errors.licenseExpiryDate}</div>
                        </div>
                      )}
                    </div>
                  </Flex>
                  ...
                  <Flex style={{ display: "flex" }}>
                    ...
                    <div className='col-lg-8 fv-row position-relative'>
                      ...
                      {formik.touched.mileage && formik.errors.mileage && (
                        <div className='fv-plugins-message-container'>
                          <div className='fv-help-block'>{formik.errors.mileage}</div>
                        </div>
                      )}
                    </div>
                  </Flex>
                  ...
                  <Flex style={{ display: "flex" }}>
                    ...
                    <div className='col-lg-8 fv-row position-relative'>
                      ...
                      {formik.touched.vin && formik.errors.vin && (
                        <div className='fv-plugins-message-container'>
                          <div className='fv-help-block'>{formik.errors.vin}</div>
                        </div>
                      )}
                    </div>
                  </Flex>
              ...
              <Flex style={{ display: "flex" }}>
                ...
                <div className='col-lg-9 fv-row position-relative'>
                  ...
                  {formik.touched.numberPlate && formik.errors.numberPlate && (
                    <div className='fv-plugins-message-container'>
                      <div className='fv-help-block'>{formik.errors.numberPlate}</div>
                    </div>
                  )}
                </div>
              </Flex>
            ...
            <div className='card-footer d-flex justify-content-end py-6 px-9'>
              ...
              >
                {!loading && (vehicleData ? `Edit ${routes[route as keyof typeof routes]}` : `Add ${routes[route as keyof typeof routes]}`)}
                {loading && (
                  <span
