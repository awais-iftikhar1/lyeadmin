...
const ColorDetails = () => {
  ...
  return (
      ...
      <Route
        ...
        element={
          <>
            ...
            <PageTitle breadcrumbs={breadCrumbsData.Color}>{routes[route as keyof typeof routes] }</PageTitle>
    ...
    <Route
      index
      element={<Navigate to='/apps/color-management/color' />}
    />
  </Routes>
  );
};
